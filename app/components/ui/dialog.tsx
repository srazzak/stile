...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <BaseDialog.Popup
      ref={ref}
      className={cn(
        "shadow-background-100/30 md:fixed inset-0 md:top-1/2 md:left-1/2 -mt-8 w-full h-full overflow-auto md:h-auto md:w-[650px] md:-translate-x-1/2 -translate-y-1/2 rounded-2xl border border-[#F0E9E0ae] bg-white/10 p-2 text-gray-900 shadow-2xl backdrop-blur-xs",
