...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <BaseDialog.Popup
      ...
      {...props}
    >
      <div className="background-gradient rounded-lg border border-[#EFE7DE] bg-radial-[at_10%_10%] from-[oklch(96.44%_0.009_62.59)] to-[oklch(94.6%_0.018_64.93)] shadow-xs">
        {children}
      </div>
    </BaseDialog.Popup>
  </DialogPortal>
